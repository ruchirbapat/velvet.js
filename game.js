...
const colourMath =
{
    ...
    colourLerp: function(col, target, time)
    {
        ...
        result.setChannel('r', this.lerp(col.getRed(), target.getRed(), time));
        result.setChannel('g', this.lerp(col.getGreen(), target.getGreen(), time));
        result.setChannel('b', this.lerp(col.getBlue(), target.getBlue(), time));
        result.setChannel('a', this.lerp(col.getAlpha(), target.getAlpha(), time));
...
var renderer = function(renderShape = shape.SQUARE)
{ }
